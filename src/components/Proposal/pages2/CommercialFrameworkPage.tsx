                  ...
                  <div className="relative z-10 space-y-8">
                     ...
                     <div className="grid grid-cols-2 gap-6 pt-2">
                        <div className="space-y-1">
                           ...
                           <div className="text-[10px] font-black tracking-tight text-[#99CB48]">Milestone Based</div>
                        </div>
                        <div className="space-y-1">
                           <div className="text-[8px] font-black tracking-wide text-white/20">Delivery Time</div>
                           <div className="text-[10px] font-black tracking-tight text-[#99CB48]">{proposal?.pricing?.deliveryTime || "30 Days"}</div>
                        </div>
                     </div>
                  </div>
               </div>
